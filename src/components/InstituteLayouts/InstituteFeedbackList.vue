<template>
  <InstitutePanel>
    <div class="feedback-form d-flex f-col">
      <h1 class="heading">Institute Feedback Form</h1>
      <div class="w70 mt-1 m-a">
        ...
        <div class="comment">
          ...
          <div class="comment-text">
            <p>
              This is the first comment. Lorem ipsum dolor sit amet, consectetur
              adipiscing elit.
            </p>
          </div>
